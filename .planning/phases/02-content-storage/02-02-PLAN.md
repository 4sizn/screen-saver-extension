...
must_haves:
  truths:
    - "Extension has reusable Button component with variants"
    - "Extension has reusable Card component for content grouping"
    - "Extension has cn() utility for className merging"
  artifacts:
