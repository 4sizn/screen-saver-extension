...
<task type="auto">
  <name>Task 1: Wire default image loading to background script</name>
...
```bash
grep -A5 "onInstalled" entrypoints/background.ts
```
  </verify>
  <done>
...
- Default image loading on first install via background script
...
**Step 2: Verify default images loaded**
1. Open browser DevTools Console
2. Look for log: "Extension installed - loading default images"
3. Look for log: "Default images loaded successfully"
4. Right-click extension icon → Options
5. Verify "Your Images (15)" appears in ImageList component
6. Verify 15 default images visible with thumbnails
7. Verify each has "Default image" label
...
4. Try clicking "Delete" on a default image
5. Verify button is NOT present (defaults protected)

**Step 7: Test keyboard navigation (accessibility)**
...
- ✓ 15 default images visible with "Default image" labels
- ✓ Image upload works with compression and validation
- ✓ Drag-and-drop reordering works (mouse and keyboard)
- ✓ Delete works for uploaded images, disabled for defaults
...
2. Manifest includes unlimitedStorage permission
3. Manifest includes images/defaults/*.jpg in web_accessible_resources
4. Extension installs successfully with 15 default images
5. All image management features work (upload, view, delete, reorder)
6. All Phase 2 success criteria validated by human
</verification>
